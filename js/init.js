// ================================================================
// init.js — アプリ起動・エラー監視・必須関数チェック
// ================================================================
// ① window.onerror / onunhandledrejection — エラーをトーストで通知
// ② safeCall — init 中のエラーで後続処理が止まらないようにする
// ⑤ REQUIRED_FNS — 必須関数 18 個の定義を起動前に確認
//    ※ 関数を削除・リネームした際は REQUIRED_FNS も更新すること
// ================================================================
